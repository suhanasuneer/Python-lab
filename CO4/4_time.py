class Time:
    def __init__(self, h, m, s):  # Constructor with Private Attributes
        self.__hours = h
        self.__minutes = m
        self.__seconds = s

    def __add__(self, other):  # + operator to add two Time objects
        ...
        hours = total_hours % 24  # wrap around 24 hours
